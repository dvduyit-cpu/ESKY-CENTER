...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::middleware('password.changed')->group(function () {
        ...
        Route::get('/admin/system-test/collaborators/{languageCollaborator}/diagnose', [AdminSystemTestController::class, 'diagnoseCollaboratorDetail'])->name('admin.system-test.collaborators.diagnose');
        ...
        Route::post('/administration/weekly-periods', [AdministrativeWeeklyReportController::class, 'storePeriod'])->middleware('permission:administration,export')->name('administration.weekly.periods.store');
        Route::put('/administration/weekly-periods/{period}', [AdministrativeWeeklyReportController::class, 'updatePeriod'])->middleware('permission:administration,export')->name('administration.weekly.periods.update');
        Route::delete('/administration/weekly-periods/{period}', [AdministrativeWeeklyReportController::class, 'destroyPeriod'])->middleware('permission:administration,export')->name('administration.weekly.periods.destroy');
        Route::patch('/administration/weekly-report-items/{item}/work-area', [AdministrativeWeeklyReportController::class, 'updateWorkArea'])->middleware('permission:administration,export')->name('administration.weekly.items.work-area');
        ...
        Route::get('/administration/weekly-summary', [AdministrativeWeeklyReportController::class, 'summary'])->middleware('permission:administration,export')->name('administration.weekly.summary');
        Route::post('/administration/weekly-summary', [AdministrativeWeeklyReportController::class, 'compile'])->middleware('permission:administration,export')->name('administration.weekly.compile');
        ...
        Route::post('/language-students/{languageStudent}/enrollments', [LanguageStudentController::class, 'storeEnrollment'])->middleware(['permission:language_students,update','permission:language_classes,update'])->name('language-students.enrollments.store');
        Route::delete('/language-students/{languageStudent}/enrollments/{enrollment}', [LanguageStudentController::class, 'destroyEnrollment'])->middleware(['permission:language_students,update','permission:language_classes,update'])->name('language-students.enrollments.destroy');
        ...
        Route::post('/language-tuition-payments/{languageTuitionPayment}/confirm-receipt',[LanguageTuitionController::class,'confirmPendingReceipt'])->middleware('permission:language_tuition,update')->name('language-tuition.confirm-receipt');
