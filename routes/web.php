...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::middleware('password.changed')->group(function () {
        ...
        Route::get('/teacher-classes/{languageClass}/enrollments-template',[LanguageClassController::class,'enrollmentTemplate'])->middleware('permission:language_classes,update')->name('teacher-classes.enrollments.template');
        Route::post('/teacher-classes/{languageClass}/enrollments-import',[LanguageClassController::class,'importEnrollments'])->middleware('permission:language_classes,update')->name('teacher-classes.enrollments.import');
        ...
        Route::post('/language-classes/{languageClass}/enrollments-import', [LanguageClassController::class, 'importEnrollments'])->middleware('permission:language_classes,update')->name('language-classes.enrollments.import');
