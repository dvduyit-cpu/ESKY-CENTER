...
@if($overview)
<section class="mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3"><div><h5 class="mb-0">Tổng quan dành cho giáo vụ</h5><small class="text-muted">Bấm vào chỉ số để lọc nhanh danh sách lớp.</small></div><span class="badge-soft badge-info"><i class="bi bi-arrow-repeat me-1"></i>Cập nhật theo dữ liệu hiện tại</span></div>
    <div class="row g-3">
