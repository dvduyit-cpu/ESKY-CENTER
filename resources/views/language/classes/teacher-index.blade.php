...
@if($class->completion_requested_at&&$class->status!=='completed')<div class="col-12 mb-n3"><span class="badge text-bg-warning"><i class="bi bi-hourglass-split me-1"></i>{{$class->code}} đang chờ giáo vụ kiểm tra học phí và đóng lớp</span></div>@endif
...
@empty
<div class="col-12"><div class="card card-soft"><div class="empty-state"><i class="bi bi-easel2 fs-1"></i><p class="mt-2">Bạn chưa được phân công lớp học nào.</p></div></div></div>
@endforelse
</div>
@endsection
