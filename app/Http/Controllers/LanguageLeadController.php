...
class LanguageLeadController extends Controller
{
    ...
    private function form(LanguageLead $item): View
    {
        ...
        return view('language.leads.form', compact('item','collaborators') + ['programs'=>LanguageProgram::where('active',1)->orderBy('name')->get(),'courses'=>LanguageCourse::where('active',1)->orderBy('name')->get(),'users'=>User::where('active',1)->orderBy('name')->get()]);
    }
