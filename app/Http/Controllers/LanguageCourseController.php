...
class LanguageCourseController extends Controller {
 ...
 private function form(LanguageCourse $item):View{return view('language.center-courses.form',['item'=>$item,'programs'=>LanguageProgram::where('active',1)->with('levels')->orderBy('name')->get()]);}
