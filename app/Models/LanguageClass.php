...
class LanguageClass extends Model {
 ...
 public function program(){return $this->belongsTo(LanguageProgram::class,'language_program_id');}
 public function level(){return $this->belongsTo(LanguageLevel::class,'language_level_id');}
 public function teacher(){return $this->belongsTo(User::class,'teacher_user_id');}
 public function completionRequester(){return $this->belongsTo(User::class,'completion_requested_by');}
