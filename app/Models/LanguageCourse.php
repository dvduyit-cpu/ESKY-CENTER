...
class LanguageCourse extends Model { use SoftDeletes; protected $guarded=[]; protected $casts=['active'=>'boolean','tuition'=>'decimal:2','duration_hours'=>'decimal:2']; public function program(){return $this->belongsTo(LanguageProgram::class,'language_program_id')->withTrashed();} public function level(){return $this->belongsTo(LanguageLevel::class,'language_level_id')->withTrashed();} public function classes(){return $this->hasMany(LanguageClass::class,'language_course_id');} }
